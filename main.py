...
from db_engine import db_session, init_db
from db_models import User, BlogPost, Comment
from forms import LoginForm, RegisterForm, CreatePostForm, CommentForm

app = Flask(__name__)
os.environ["SECRET_KEY"] = "this secret key"
...
def favicon():
    """
    loads favicon from here instead of templates
    :return:
    """
